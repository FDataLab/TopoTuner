...
def main() -> None:
    ...
    ap.add_argument("--families", choices=("llama", "qwen-base", "mistral-7b-v03", "all"), default="all")
    ap.add_argument(
        "--signed",
        action="store_true",
    ...
    ap.add_argument("--baseline-mistral", type=str, default=None)
    args = ap.parse_args()
    ...
    fams: List[str] = ["llama", "qwen-base", "mistral-7b-v03"] if args.families == "all" else [args.families]
    modes: List[str] = ["final", "avg"] if args.mode == "both" else [args.mode]

    baseline_overrides = {
        "llama": args.baseline_llama,
        "qwen-base": args.baseline_qwen_base,
        "mistral-7b-v03": args.baseline_mistral,
    }
