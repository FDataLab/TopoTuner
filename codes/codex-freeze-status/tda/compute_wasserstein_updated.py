...
def compute_single_wasserstein(args):
    ...
    try:
        ...
        # Compute Wasserstein distance for H0 and H1 persistence diagrams (Gudhi, order=2)
        h0 = wasserstein_distance(dgm1[0], dgm2[0], order=2)
        h1 = wasserstein_distance(dgm1[1], dgm2[1], order=2)
