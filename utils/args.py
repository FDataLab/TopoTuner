...
def parse_args():
    ...
    parser.add_argument("--dataset-name", type=str, default="FinEntity", help="Dataset name")
    ...
    parser.add_argument("--output-dir", type=str, default="./FinEntity/finetuned_model", help="Directory to save the fine-tuned model")
